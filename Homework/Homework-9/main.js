...
block.textContent = 'This is a block';
...
for (let course of coursesAndDurationArray) {
    ...
    block.textContent = `Title: ${course.title}, Duration: ${course.monthDuration} months`;
...
coursesArray.forEach(course => {
    ...
    monthDurationDiv.textContent = `Month duration: ${course.monthDuration}`;
    ...
    hourDurationDiv.textContent = `Hour duration: ${course.hourDuration}`;
